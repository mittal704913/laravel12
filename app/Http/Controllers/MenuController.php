...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('menus.index')->with('success', 'Menu successfully created.');
    }
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        return redirect()->route('menus.index')->with('success', 'Menu successfully updated.');
    }
    ...
    public function reorder(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Menu order successfully saved.');
    }
}
